...
const translations = {
    fr: {
        ...
        hero_badge: "Une équipe 100% féminine",
    ...
    ar: {
        ...
        hero_kicker: "— تصوير أعراس بأسلوب فني راقٍ —",
        hero_l1: "الخلود",
        hero_l2: "<em>في النور</em>",
        hero_sub: "رؤية سينمائية للعرس. صور مرهفة، خالدة، مصمَّمة كأعمال فنية.",
        hero_badge: "فريق نسائي 100%",
        ...
        about_p1: "نحن راويات قصص بصرية، مرهفات الحسّ تجاه اللعب الصامت للضوء على البشرة، والعمارة الخالدة، وصدق النظرة.",
        about_p2: "مقيمات في تطوان منذ 2015، فريقنا — النسائي بالكامل — يستمدّ إلهامه من الثراء الثقافي للمغرب، ومن حيائه، ومن الألفة العفوية التي تنشأ بين النساء يوم العرس.",
        about_p3: "متمرّسات على معايير النشر الدولية، نكرّس كل عرس لأمر واحد: صون قصتكم بالأناقة التي تستحقها.",
        stat_since: "منذ",
        ...
        team_kicker: "— اللحظة —",
        team_text: "تصوير العرس يعني أن نتوارى عن الأنظار لنلتقط جوهر اللحظة.",
